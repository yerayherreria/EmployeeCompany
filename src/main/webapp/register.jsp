	      ...
	      <div class="card border-0 rounded-3 shadow-lg">
	        <div class="card-body p-4">
	          <div class="text-center">
	            <div class="h1 fw-light">Register</div>
	          </div>
	          ...
	          <form method="get">
	            ...
	            <div class="d-grid">
	              	<button class="btn btn-primary btn-lg" id="submitButton" type="submit" name="submit">Save</button>&nbsp
	              	<%if(request.getParameter("submit") != null) {%>
	              		<a href="./index.jsp"><button class="btn btn-danger btn-lg" id="register" value="register" type="button" name="register">Return Login</button></a>
	              	<%} %>
	            </div>
